(function(){
  ...
  function category(v){var labels={'abandonware':'Abandonware','android-ports':'Android Ports','browser-based':'Browser Based','console-ports':'Console To Console Ports','console-to-pc-port':'Console To PC Ports','decompilations-recompilations':'Decompilations & Recompilations','english-translation-patches':'English Translation Patches','fan-games':'Fan Games & Homebrew','guides':'Guides','in-the-works':'In The Works','mods':'Mods','open-source':'Open Source','preserved-games':'Preserved Games','rom-hacks':'ROM Hacks','texture-packs':'Texture Packs','utility':'Utilities','vr-ports':'VR Ports'};return labels[v]||v||'No category';}
